...
export const MANUFACTURER_URL: string | undefined =
  process.env.MANUFACTURER_URL;

export const CACHE_TIMER: number = Number(process.env.CACHE_TIMER) || 300;
export const TEST_CACHE_TIMER: number =
  Number(process.env.TEST_CACHE_TIMER) || 60;
...
export const START_CRON: number | undefined =
  Number(process.env.START_CRON) || undefined;
export const END_CRON: number | undefined =
  Number(process.env.END_CRON) || undefined;
